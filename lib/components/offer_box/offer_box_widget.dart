...
import 'offer_box_model.dart';
export 'offer_box_model.dart';

class OfferBoxWidget extends StatefulWidget {
  const OfferBoxWidget({
    super.key,
    this.offer,
  });

  final ProductsRecord? offer;

  @override
  State<OfferBoxWidget> createState() => _OfferBoxWidgetState();
}

class _OfferBoxWidgetState extends State<OfferBoxWidget> {
  late OfferBoxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OfferBoxModel());
  }
                        ...
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              'i9sbqjxk' /* Are you sure you want to Remov... */,
                            ),
