...
import 'completed_order_model.dart';
export 'completed_order_model.dart';
...
class _CompletedOrderWidgetState extends State<CompletedOrderWidget> {
  late CompletedOrderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompletedOrderModel());
  }
                  ...
                  Text(
                    valueOrDefault<String>(
                      FFLocalizations.of(context).languageCode == 'en'
                          ? containerTranslatorRecord?.completedOrder
                          : containerTranslatorRecord?.completedOrderAr,
                      '0',
                    ),
                        ...
                        children: [
                          TextSpan(
                            text: valueOrDefault<String>(
                              FFLocalizations.of(context).languageCode == 'en'
                                  ? containerTranslatorRecord?.sureCompleteOrder
                            ...
                            onPressed: () async {
                              if (valueOrDefault(
                                ...
                                await notificationRecordReference
                                  ...
                                  descreption:
                                      'Your Order(Order #${widget.order?.orderId}) Has Been Completed.',
                                  time: getCurrentTimestamp,
                                  viewed: false,
                                  title: 'Your Order Has Completed',
                                  statuesType: 'Completed',
