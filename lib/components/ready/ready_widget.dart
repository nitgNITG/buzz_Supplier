...
import 'ready_model.dart';
export 'ready_model.dart';
...
class _ReadyWidgetState extends State<ReadyWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReadyModel());
  }
                  ...
                  Text(
                    '${valueOrDefault<String>(
                      FFLocalizations.of(context).languageCode == 'en'
                          ? containerTranslatorRecord?.readyOrder
                          : containerTranslatorRecord?.readyOrderAr,
                      '0',
                    )} ?',
                        ...
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              'xxxjswi2' /* Are you sure you want to ready... */,
                            ),
                            ...
                            onPressed: () async {
                              if (valueOrDefault(
                                ...
                                await notificationRecordReference
                                  ...
                                  descreption:
                                      'Your Order(Order #${widget.order?.orderId}) Has Been Ready.',
                                  time: getCurrentTimestamp,
                                  viewed: false,
                                  title: 'Your Order Has Ready',
                                  statuesType: 'Ready',
