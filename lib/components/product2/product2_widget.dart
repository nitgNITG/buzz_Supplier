...
import 'product2_model.dart';
export 'product2_model.dart';

class Product2Widget extends StatefulWidget {
  const Product2Widget({
    super.key,
    this.prod2,
  });

  final ProductsRecord? prod2;

  @override
  State<Product2Widget> createState() => _Product2WidgetState();
}

class _Product2WidgetState extends State<Product2Widget> {
  late Product2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Product2Model());
  }
                  ...
                  Text(
                    '${valueOrDefault<String>(
                      FFLocalizations.of(context).languageCode == 'en'
                          ? containerTranslatorRecord?.manageProduct
                          : containerTranslatorRecord?.manageProductAr,
                      '0',
                    )} ?',
                        ...
                        children: [
                          TextSpan(
                            text: FFLocalizations.of(context).getText(
                              'xw5tnlxy' /* Are you sure you want to Undo ... */,
                            ),
