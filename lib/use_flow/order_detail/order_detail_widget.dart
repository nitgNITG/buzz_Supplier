...
import '/components/cancel_order/cancel_order_widget.dart';
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              'Order# ${orderDetailOrderRecord.orderId}',
                                              style:
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<UserRecord>(
                              stream: UserRecord.getDocument(
                                  orderDetailOrderRecord.supplier!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Builder(
                                        builder: (context) {
                                          final pro = orderDetailOrderRecord
                                              .productData
                                              .toList();
                                                              ...
                                                              text: TextSpan(
                                                                children: [
                                                                  ...
                                                                  TextSpan(
                                                                    text: functions
                                                                        .subpriceTotal(
                                                                            listViewProductsRecord.originalPrice.toDouble(),
                                                                            proItem.quantity.toDouble())
                                                                        .toString(),
                                                                    style: GoogleFonts
                                                                        .getFont(
                                                                      'Cairo',
