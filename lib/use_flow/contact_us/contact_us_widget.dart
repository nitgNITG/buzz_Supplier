                                        ...
                                        decoration: InputDecoration(
                                          labelText: valueOrDefault<String>(
                                            FFLocalizations.of(context)
                                                        .languageCode ==
                                                    'en'
                                                ? stackTranslatorRecord?.name
                                                : stackTranslatorRecord?.nameAr,
                                            'm',
                                          ),
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                          ...
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                await ContantUsRecord.collection
                                    .doc()
                                    .set(createContantUsRecordData(
                                      name: _model.textController2.text,
                                      email: _model.textController3.text,
                                      coment: _model.textController4.text,
                              ...
                              text: valueOrDefault<String>(
                                FFLocalizations.of(context).languageCode == 'en'
                                    ? stackTranslatorRecord?.submit
                                    : stackTranslatorRecord?.submitAr,
                                'm',
                              ),
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  FFLocalizations.of(context).languageCode ==
                                          'en'
                                      ? stackTranslatorRecord?.contactUs
                                      : stackTranslatorRecord?.contactUsAr,
                                  'm',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .titleSmall
