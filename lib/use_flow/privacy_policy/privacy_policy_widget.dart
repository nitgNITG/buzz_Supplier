  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AppDataRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AppDataRecord> privacyPolicyAppDataRecordList = snapshot.data!;
        final privacyPolicyAppDataRecord =
            privacyPolicyAppDataRecordList.isNotEmpty
                ? privacyPolicyAppDataRecordList.first
                : null;
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      FFLocalizations.of(context)
                                                  .languageCode ==
                                              'en'
                                          ? stackTranslatorRecord?.privacyPolicy
                                          : stackTranslatorRecord
                                              ?.privacyPolicyAr,
                                      'm',
                                    ),
