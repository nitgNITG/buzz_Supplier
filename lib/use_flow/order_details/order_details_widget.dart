  ...
  Widget build(BuildContext context) {
    return StreamBuilder<OrderRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final orderDetailsOrderRecord = snapshot.data!;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Stack(
                            children: [
                              if (orderDetailsOrderRecord.status == 'Cancelled')
                                ClipRRect(
                              ...
                              if ((orderDetailsOrderRecord.status ==
                                      'Completed') ||
                                  (orderDetailsOrderRecord.status ==
                                      'Accepted'))
                                ClipRRect(
                                  borderRadius: const BorderRadius.only(
                                    bottomLeft: Radius.circular(0.0),
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 20.0, 0.0, 0.0),
                            child: Text(
                              'SAR ${orderDetailsOrderRecord.total.toString()}',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Cairo',
                          ...
                          Text(
                            'Order No: ${orderDetailsOrderRecord.orderId}',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Cairo',
                          ...
                          StreamBuilder<UserRecord>(
                            stream: UserRecord.getDocument(
                                orderDetailsOrderRecord.supplier!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                          ...
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text: orderDetailsOrderRecord.status,
