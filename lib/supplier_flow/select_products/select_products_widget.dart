...
import '/components/featured_product/featured_product_widget.dart';
...
class SelectProductsWidget extends StatefulWidget {
  ...
  @override
  State<SelectProductsWidget> createState() => _SelectProductsWidgetState();
}
                              ...
                              Text(
                                valueOrDefault<String>(
                                  FFLocalizations.of(context).languageCode ==
                                          'en'
                                      ? stackTranslatorRecord?.selectProducts
                                      : stackTranslatorRecord?.selectProductsAr,
                                  'm',
                                ),
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        mainAxisSize:
                                                                            MainAxisSize.max,
                                                                        children: [
                                                                          if (gridViewProductsRecord.featured ==
                                                                              false)
                                                                            Container(
                                                                              width: 25.0,
                                                                              height: 25.0,
                                                                              ...
                                                                              child: Visibility(
                                                                                visible: gridViewProductsRecord.featured == false,
                                                                                child: Align(
                                                                          ...
                                                                          if (gridViewProductsRecord.featured ==
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Visibility(
                                                                                visible: gridViewProductsRecord.featured == true,
                                                                                child: Align(
                                                                                  alignment: const AlignmentDirectional(0.0, 0.0),
                                                                                  child: InkWell(
                                                                                    splashColor: Colors.transparent,
