...
import 'register_map_model.dart';
export 'register_map_model.dart';

class RegisterMapWidget extends StatefulWidget {
  const RegisterMapWidget({super.key});

  @override
  State<RegisterMapWidget> createState() => _RegisterMapWidgetState();
}

class _RegisterMapWidgetState extends State<RegisterMapWidget> {
  late RegisterMapModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterMapModel());
