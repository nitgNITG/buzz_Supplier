...
class _SupplierProfileWidgetState extends State<SupplierProfileWidget>
  ...
  void initState() {
    ...
    _model.fullNameTextController1 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.avgRating, 0.0).toString());
            ...
            builder: (context, snapshot) {
              ...
              return Stack(
                children: [
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  FFLocalizations.of(context).languageCode ==
                                          'en'
                                      ? stackTranslatorRecord?.appNameSupplier
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 90.0, 0.0, 80.0),
                    child: SingleChildScrollView(
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                                                        ...
                                                        builder: (context) =>
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            onChanged: (_) =>
                                                                EasyDebounce
                                                                    .debounce(
                                                              '_model.fullNameTextController5',
                                                              const Duration(
                                                                  milliseconds:
                                                                      1000),
                                                              () =>
                                          ...
                                          child: Container(
                                            ...
                                            child: Align(
                                              alignment: const AlignmentDirectional(
                                                  0.0, 0.0),
                                              child: Text(
                                                containerOrderRecordList.length
                                                    .toString(),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
