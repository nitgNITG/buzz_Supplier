...
import 'payment_profile_model.dart';
export 'payment_profile_model.dart';
...
class _PaymentProfileWidgetState extends State<PaymentProfileWidget>
  ...
  late PaymentProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentProfileModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<BranchesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BranchesRecord> paymentProfileBranchesRecordList = snapshot.data!;
        final paymentProfileBranchesRecord =
            paymentProfileBranchesRecordList.isNotEmpty
                ? paymentProfileBranchesRecordList.first
                : null;
                                                            ...
                                                            valueOrDefault<
                                                              ...
                                                              formatNumber(
                                                                functions.apppercentage(
                                                                    functions.calculateTotalPrice(paymentProfileBranchesRecord
                                                                        ?.branchTotal
                                                                        .toList()),
                                                                    valueOrDefault(
                                                                        currentUserDocument
