...
import '/components/product2/product2_widget.dart';
...
import 'deleted_products_page_model.dart';
export 'deleted_products_page_model.dart';

class DeletedProductsPageWidget extends StatefulWidget {
  const DeletedProductsPageWidget({super.key});

  @override
  State<DeletedProductsPageWidget> createState() =>
      _DeletedProductsPageWidgetState();
}

class _DeletedProductsPageWidgetState extends State<DeletedProductsPageWidget> {
  late DeletedProductsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeletedProductsPageModel());
  }
                              ...
                              Text(
                                valueOrDefault<String>(
                                  FFLocalizations.of(context).languageCode ==
                                          'en'
                                      ? stackTranslatorRecord?.deletedProducts
                                                                                  ...
                                                                                  builder: (context) {
                                                                                    return GestureDetector(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: Product2Widget(
                                                                                          prod2: gridViewProductsRecord,
                                                                                        ),
                                                                                      ),
                                                                                    );
                                                                                  },
                                                                ...
                                                                if (gridViewProductsRecord
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                        Visibility(
                                                                      visible:
                                                                          gridViewProductsRecord.featured ==
                                                                              true,
                                                                      child:
                                                                          Padding(
                                                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                            ...
                                                                            FFLocalizations.of(context).languageCode == 'en'
                                                                                ? stackTranslatorRecord?.featured
                                                                                : stackTranslatorRecord?.featuredAr,
                                                                            'm',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
